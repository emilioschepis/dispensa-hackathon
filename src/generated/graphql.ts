...
export type ItemsInInventoryQuery = { __typename?: 'query_root', items: Array<{ __typename?: 'inventory_items', quantity: number, product: { __typename?: 'products', id: string, name: string, code?: string | null } }> };
